...
namespace CryptoDCA.DataAccess.Migrations
{
    ...
    [Migration("20241016204101_PeriodsChangeDataType")]
    partial class PeriodsChangeDataType
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CryptoDCA.DataModel.Context.Currencies", b =>
                {
                    ...
                    b.Property<string>("ProgId")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)")
                        .HasColumnName("GOT_CURRENCY_PROGID");
            ...
            modelBuilder.Entity("CryptoDCA.DataModel.Context.Periods", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                        .HasColumnName("GOT_INVEST_PERIOD_ID");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("Id"));

                    b.Property<int>("Days")
                        .HasColumnType("int")
                        .HasColumnName("GOT_INVEST_PERIOD_DAYS");

                    b.Property<string>("Description")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)")
                        .HasColumnName("GOT_INVEST_PERIOD_DESCRIPTION");

                    b.Property<bool>("IsActive")
                        .HasColumnType("bit")
                        .HasColumnName("GOT_INVEST_PERIOD_ISACTIVE");

                    b.Property<string>("Name")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)")
                        .HasColumnName("GOT_INVEST_PERIOD_NAME");

                    b.Property<string>("ProgId")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)")
                        .HasColumnName("GOT_INVEST_PERIOD_PROGID");

                    b.HasKey("Id");

                    b.ToTable("GOT_INVEST_PERIOD");
                });
